            ...
            <div class="box-header with-border">
              ...
              <div class="box-tools pull-right">
                ...
                <label>Nim</label>
                    ...
                    <label>Nama</label>
                    <input type="text" name="nama_mhs" value="<?php echo $row['nama_mhs'];?>" class="form-control" placeholder="Enter..." required="">
                    </div> 
                    <label>Tanggal Lahir</label>
                    <input type="text" name="tgl_lahir" value="<?php echo $row['tgl_lahir'];?>" class="form-control" placeholder="Enter..." required="">
                    </div> 
                     <div class="col-md-12 form-group">
                         <label>Alamat</label>
                    ...
                    <label>JK</label>
                    <input type="text" name="jk_mahasiswa" value="<?php echo $row['jk_mahasiswa']?>" class="form-control" placeholder="Enter..." required="">
                    </div> 
                 <div class="col-md-12 form-group"> 
            ...
            <div class="box-body">
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td><?php echo $row['jk_mahasiswa'];?></td>
                            <td>
                                <a href="<?php $_SERVER[SCRIPT_NAME] ;?>?page=mahasiswa&nim=<?php echo $row['nim'];?>" class="btn btn-info"><li class="fa fa-pencil"></li> Edit</a> 
                                <a href="aksi.php?sender=hapus&nim=<?php echo $row['nim']; ?>" class="btn btn-danger"><li class="fa fa-trash-o"></li> Hapus</a> 
                             </td>
                        </tr> 
                            <?php    
                    $no++;                    
...
<!-- Modal -->
<form action="aksi.php?sender=mahasiswa" method="POST" >
...
<div class="modal-body center"> 
 <!--Content-->
  ...
  <div class="form-group">
    ...
    <div class="form-group">
      <label>Nama</label>
      <input type="text" name="nama_mhs" class="form-control" required="" placeholder="Enter ...">
    </div>
    ...
    <div class="form-group">
      <label>Tanggal Lahir</label>
      <textarea type="text" name="tgl_lahir" class="form-control" placeholder="Enter ..."></textarea> 
    </div>

    <div class="form-group">
      <label>Jenis Kelamin</label>
      <textarea type="text" name="jk_mahasiswa" class="form-control" placeholder="Enter ..."></textarea> 
    </div>
